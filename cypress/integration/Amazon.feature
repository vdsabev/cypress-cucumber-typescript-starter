Feature: Add book to basket
  ...
  Scenario: Open home page
    Given the customer is on the "Amazon Home" page
     Then the page title should contain "Amazon.co.uk"

#   Scenario: Search for book
#     Given the customer is on the "Amazon Home" page
#      When the customer searches for "Harry Potter and the Cursed Child"
#      Then the first result's title should contain "Harry Potter and the Cursed Child - Parts One and Two"
#       And the first result's badge should be "Best Seller"
#       And the first result should have a "Paperback" edition with a price of "£4.00"
...
#       And the book's title should contain "Harry Potter and the Cursed Child - Parts One and Two"
...
#     Given the customer is on the "Book Details" page for "Harry Potter and the Cursed Child - Parts One and Two"
#      When the customer clicks on the "Add to Basket" button
#      Then the page title should be "Amazon.co.uk Shopping Basket"
#       And the basket item's title should contain "Harry Potter and the Cursed Child - Parts One and Two"
